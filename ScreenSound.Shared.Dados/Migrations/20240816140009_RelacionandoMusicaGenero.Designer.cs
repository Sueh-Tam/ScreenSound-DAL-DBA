...
namespace ScreenSound_OFC.Migrations
{
    ...
    [Migration("20240816140009_RelacionandoMusicaGenero")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScreenSound_OFC.Modelos.Artista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ScreenSound_OFC.Modelos.Musica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeneroMusica", b =>
                {
                    ...
                    b.HasOne("ScreenSound_OFC.Modelos.Musica", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ScreenSound_OFC.Modelos.Musica", b =>
                {
                    b.HasOne("ScreenSound_OFC.Modelos.Artista", "Artista")
                        .WithMany("Musicas")
